    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          <h1 className="h1 mb-6" style={{ color: '#5D4037' }}>
            Te ayudo a tener el cabello {` `}
            <span className="inline-block relative" style={{ color: '#FACF78' }}> {/* <-- Cambio: Asegúrate de que sea `inline` */}
              sano,
            </span>
            <span className="inline-block relative" style={{ color: '#B8F589' }}> {/* <-- Cambio: Asegúrate de que sea `inline` */}
              largo,
            </span>
            ...
            <img
              src={curve}
              className="absolute top-[calc(100% + 1rem)] left-0 w-full xl:-mt-2"
              width={624}
              height={28}
              alt="Curve" />
          </h1>
              ...
              <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                ...
                <ScrollParallax isAbsolutelyPositioned>
                  <Notification
                    ...
                    title="¡Bienvenid@s a la comunidad más grande del mundo dedicada a la alopecia!" />
                </ScrollParallax>
              </div>
            </div>
